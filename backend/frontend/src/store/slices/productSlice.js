...
export const fetchMenProducts = createAsyncThunk("fetchMenProducts",async()=>{
  const res = await fetch(`${window.location.origin}/api/product/men`,{
    method:"GET",
    headers:{
...
export const fetchWomenProducts = createAsyncThunk("fetchWomenProducts",async()=>{
  const res = await fetch(`${window.location.origin}/api/product/women`,{
    method:"GET",
    headers:{
      "Content-Type":"application/json"
    }
...
export const fetchKidsProducts = createAsyncThunk("fetchKidsProducts",async()=>{
  const res = await fetch(`${window.location.origin}/api/product/kids`,{
    method:"GET",
    headers:{
      "Content-Type":"application/json"
    }
...
export const fetchProduct = createAsyncThunk("fetchProduct",async(productId)=>{
  const res = await fetch(`${window.location.origin}/api/product/oneProduct/${productId}`,{
    method:"GET",
    headers:{
      "Content-Type":"application/json",
    }
...
export const fetchPopularProducts = createAsyncThunk("fetchPopularProducts",async()=>{
  const res = await fetch(`${window.location.origin}/api/product/getPopularProducts`,{
    method:"GET",
    headers:{
      "Content-Type":"application/json"
    }
